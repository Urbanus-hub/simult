    ...
    <div className={cn("ease-in-out duration-300", className)} {...props}>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button
          ...
          variant="outline"
          disabled={true}
          className="h-10 rounded-lg border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 font-medium text-xs hover:cursor-not-allowed"
        >
        ...
        <Button
          ...
          variant="outline"
          disabled={true}
          className="h-10 rounded-lg border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 font-medium text-xs hover:cursoer-not-allowed"
        >
